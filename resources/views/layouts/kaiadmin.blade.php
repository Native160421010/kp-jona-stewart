...
$filePath = 'assets/img/lms/logo';
$found = false;

// LOGO LMS
foreach ($extensions as $ext) {
    if (file_exists(public_path("$filePath.$ext"))) {
        $filePath .= ".$ext";
        $found = true;
        break;
    }
...
// PFP USER
$name = Auth::user()->name;
$filePathPfp = 'assets/img/lms/profiles/' . $name;
$foundPfp = false;

foreach ($extensions as $ext) {
    if (file_exists(public_path("$filePathPfp.$ext"))) {
        $filePathPfp .= ".$ext";
        $foundPfp = true;
        break;
    }
...
if (!$foundPfp) {
    $filePathPfp = 'assets/img/empty.jpg';
}
?>
            ...
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="index.html" class="logo">
                        <img src="{{ asset($filePath) }}" alt="navbar brand" class="navbar-brand" height="100" />
                    </a>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="forms">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="#">
                                            <span class="sub-item">Site Appearance</span>
                                        </a>
                                        <a href="#">
                                            <span class="sub-item">Grades</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        <li>
                                            <div class="user-box">
                                                <div class="avatar-lg">
                                                    <img src="{{ asset($filePathPfp) }}" alt="image profile"
